...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('yadba_entry', 'draft', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Entry.draft'
        db.delete_column('yadba_entry', 'draft')
